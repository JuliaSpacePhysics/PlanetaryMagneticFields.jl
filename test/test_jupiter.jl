...
@testset "Model loading" begin
    # Test JRM09 loading
    jrm09 = PlanetaryMagneticFields.load_model("jrm09")
    ...
    jrm33_13 = PlanetaryMagneticFields.load_model("jrm33", max_degree = 13)
    @test degree(jrm33_13) == 13
    @test order(jrm33_13) == 13

    # Test full JRM33
    jrm33_full = PlanetaryMagneticFields.load_model("jrm33")
...
@testset "Available models" begin
    models = PlanetaryMagneticFields.available_models(:jupiter)
...
@testset "JRM33 vs JRM09 comparison" begin
    jrm09 = PlanetaryMagneticFields.load_model("jrm09")
    jrm33 = PlanetaryMagneticFields.load_model("jrm33", max_degree = 10)
